...
class BUTTONS(object):
    ...
    PBUTTON = [
        [
            InlineKeyboardButton("Ꮤαѕтᥱ ⴕ", url="https://t.me/jp_network")
        ],
        [
    ...
    ABUTTON = [
        [
            InlineKeyboardButton("⌯ sυᴘᴘσʀᴛ ⌯", url="https://t.me/WasteSupport"),
            InlineKeyboardButton("⌯ υᴘᴅᴧᴛєs ⌯", url="https://t.me/jp_network"),
        ],
        [
