...
OWNER_USERNAME = getenv("OWNER_USERNAME","II_JPEXO_II")
BOT_USERNAME = getenv("BOT_USERNAME" , "@Adamusiicbot")
BOT_NAME = getenv("BOT_NAME" , "˹ ⋏ ᑯ ᥲ ┋ 𐌼 ᥙ s ɪ ᴄ ✞")
ASSUSERNAME = getenv("ASSUSERNAME" , "Waste")
...
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://t.me/jp_network",)
